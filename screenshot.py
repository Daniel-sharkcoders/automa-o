...
def main(page: ft.Page):
    ...
    def screenshot(e):
        sleep(2)
        for i in range(int(repetir.value)):
    ...
    x = ft.TextField(label="Qual a coordenada X?", border_color="#A3BAC3")
    y = ft.TextField(label="Qual a coordenada Y?", border_color="#A3BAC3")
    ...
    coluna = ft.Column(controls=[txt, x, y, repetir, tempo, ft.Row(
        controls=[btn], spacing=20,
